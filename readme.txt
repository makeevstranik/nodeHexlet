...
Используем самописный map для отображения структуры. Функция, которая будет изменять элементы (но не структуру)
передается, в виде анонимной. Внимательно читать пояснения в коде. Интересное использование spread и деструктивного
присваивания.